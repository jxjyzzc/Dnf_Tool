...
from yolo.nets.yolo import yolo_body
from yolo.utils.utils import (cvtColor, get_anchors, get_classes, preprocess_input,
                         resize_image, show_config)
from yolo.utils.utils_bbox import DecodeBox, DecodeBoxNP
...
class YOLO(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : 'yolo/model_data/best_epoch_weights.h5',
        "classes_path"      : 'yolo/model_data/dnf_classes.txt',
        #---------------------------------------------------------------------#
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        for i, c in list(enumerate(out_classes)):
            ...
            labels.append({"label":label, "top":top, "left":left, "bottom":bottom, "right":right})
